# Generated by Django 4.1.7 on 2023-05-19 16:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hinh_anh', models.ImageField(upload_to='images/', verbose_name='Hình ảnh')),
                ...
                ('phong', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='QLthietbi_app.phong', verbose_name='Phòng')),
                ('tang', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='QLthietbi_app.tang', verbose_name='Tầng')),
            ],
            options={
